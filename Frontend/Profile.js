...
export default function Profile() {
    return (<>
        <div className="lg:min-w-[50%] border-2 border-red-400 text-white">
                        ...
                        <li class="mr-5 shrink-0 text-xs">
                            <a class="block hover:text-slate-200" href="https://leetcode.com/u/uditdamare01/" target="_blank" rel="noreferrer noopener" aria-label="LeetCode (opens in a new tab)" title="LeetCode">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path fill="#ffffff" d="M496 64H16C7.163 64 0 71.163 0 80v352c0 8.837 7.163 16 16 16h480c8.837 0 16-7.163 16-16V80c0-8.837-7.163-16-16-16zm-48 352H64V128h384v288zM256 192c-35.346 0-64 28.654-64 64s28.654 64 64 64 64-28.654 64-64-28.654-64-64-64zm0 96c-17.673 0-32-14.327-32-32s14.327-32 32-32 32 14.327 32 32-14.327 32-32 32z" />
                                </svg> */}
                            </a>
                        </li>
                        <li class="mr-5 shrink-0 text-xs">
